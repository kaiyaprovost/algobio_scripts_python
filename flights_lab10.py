...
cityNum["Phoenix"] = 4
cityNum["Tacoma"] = 5
cityNum["Kansas City"] = 6

#flights = np.zeros( (4,4) )
flights = np.zeros( (len(cityNum),len(cityNum)) )
...
flights[cityNum["San Jose"],cityNum["Phoenix"]] = 1
flights[cityNum["Houston"],cityNum["Phoenix"]] = 1
flights[cityNum["Phoenix"],cityNum["San Jose"]] = 1
flights[cityNum["Phoenix"],cityNum["Houston"]] = 1

flights[cityNum["Chicago"],cityNum["Tacoma"]] = 1
flights[cityNum["New York"],cityNum["Tacoma"]] = 1
flights[cityNum["Tacoma"],cityNum["Chicago"]] = 1
flights[cityNum["Tacoma"],cityNum["New York"]] = 1
flights[cityNum["San Jose"],cityNum["Tacoma"]] = 1
flights[cityNum["Tacoma"],cityNum["San Jose"]] = 1

flights[cityNum["Kansas City"],cityNum["Phoenix"]] = 1
flights[cityNum["Phoenix"],cityNum["Kansas City"]] = 1
